...
urlpatterns = [
    ...
    path('invoices/<uuid:pk>/due-date/', views.InvoiceDueDateView.as_view(), name='invoice_due_date'),
    ...
    path('quotes/<uuid:pk>/mark-expired/', views.QuoteMarkExpiredView.as_view(), name='quote_mark_expired'),
    path('shipping/<uuid:shipping_pk>/shipments/<uuid:shipment_pk>/status/', views.ShipmentStatusUpdateView.as_view(), name='shipment_status_update'),
